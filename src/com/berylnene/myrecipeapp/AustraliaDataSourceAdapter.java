...
public class AustraliaDataSourceAdapter extends BaseAdapter {
	private Context myContext;
	private LayoutInflater myFlater;
	private AustraliaDataSource myDataSource;
	
	public AustraliaDataSourceAdapter(Context ctx,AustraliaDataSource as1){
		myContext = ctx;
		myDataSource = as1;
